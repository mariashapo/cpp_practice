...
#define ERROR_START_STATION_INVALID -1  // X
#define ERROR_ROUTE_ENDPOINT_IS_NOT_STATION -2 // X
#define ERROR_LINE_HOPPING_BETWEEN_STATIONS -3 // X
#define ERROR_BACKTRACKING_BETWEEN_STATIONS -4 // ..
#define ERROR_INVALID_DIRECTION -5 // X
#define ERROR_OFF_TRACK -6 // ...
#define ERROR_OUT_OF_BOUNDS -7 // X
...
// cannot do const for the map here? why?
