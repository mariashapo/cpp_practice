...
int main() {
  ...
  ascii_to_binary('3',binary);
  cout << "The ASCII code of '3' is " << int('3') << " which in binary is " << binary << endl << endl;

  char ch;
  ch = binary_to_ascii("01000001");
  cout << "The character correspoding to the binary number 01000001 is '" << ch << "'" << endl << endl;

  ch = binary_to_ascii("00010001");
  cout << "The character correspoding to the binary number 00000001 is '" << ch << "'" << endl << endl;
  ...
  cout /*<< decoded*/ << " (" << errors << " errors corrected)" << endl;  
